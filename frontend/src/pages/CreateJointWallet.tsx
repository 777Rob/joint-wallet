...
const CreateJointWallet = ({
  ...
  return (
    <div className="text-center">
      ...
      <p className="text-xl mb-10 font-normal">
        ...
        >
          <div className="col-span-6 text-left">
            ...
            <div className="text-sm text-red-500 mt-1">
              {activeErrors.walletName}
            </div>
          </div>

          <div
            className="text-left col-span-3 flex flex-col space-y-1.5"
            role="radiogroup"
          >
            ...
            >
              <input
                ...
                className={`${
                  jointAccountProps.isStatic && "bg-skin-highlight"
                }`}
              />
          ...
          <div
            className="text-left col-span-3 flex flex-col space-y-1.5 mb-12"
            role="radiogroup"
          >
          ...
          <h4 className="col-span-6 text-center font-semibold  text-2xl mb-6">
            Add signers
          </h4>
          ...
          <div className="col-span-6 mb-10">
            Maximum: {jointAccountProps.members.length}
          </div>
